...
class MarketStateEngine:
    ...
    def update(self, index, underlying, ce, pe):
        ...
        try:
            ...
            ce_absorb = self._clamp(
                self._extract_feature(ce, "absorption_strength", "absorb", "absorption_score", default=0.0),
                0.0,
                1.0,
            )
            pe_absorb = self._clamp(
                self._extract_feature(pe, "absorption_strength", "absorb", "absorption_score", default=0.0),
                0.0,
                1.0,
            )
            ce_vacuum = self._clamp(
                self._extract_feature(ce, "vacuum_strength", "vacuum", "vacuum_score", default=0.0),
                0.0,
                1.0,
            )
            pe_vacuum = self._clamp(
                self._extract_feature(pe, "vacuum_strength", "vacuum", "vacuum_score", default=0.0),
                0.0,
                1.0,
            )
