...
class TriWaveV2Brain:
    MIN_BREATHING_HOLD_SEC=180;SOFT_EXIT_MIN_HOLD_SEC=200;NORMAL_EXIT_MIN_HOLD_SEC=240;PROFIT_EXIT_MIN_HOLD_SEC=180
    FAST_ADVERSE_PCT=-4.0;FAST_ADVERSE_MIN_HOLD_SEC=180;ADVERSE_EXIT_PCT=-2.0;ADVERSE_EXIT_MIN_HOLD_SEC=180
