...
class TriWaveV2Brain:
    MIN_BREATHING_HOLD_SEC=60;SOFT_EXIT_MIN_HOLD_SEC=120;NORMAL_EXIT_MIN_HOLD_SEC=120;PROFIT_EXIT_MIN_HOLD_SEC=80
    FAST_ADVERSE_PCT=-4.0;FAST_ADVERSE_MIN_HOLD_SEC=60;ADVERSE_EXIT_PCT=-2.0;ADVERSE_EXIT_MIN_HOLD_SEC=60
