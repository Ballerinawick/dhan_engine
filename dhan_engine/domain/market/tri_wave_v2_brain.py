...
class TriWaveV2Brain:
    MIN_BREATHING_HOLD_SEC=120;SOFT_EXIT_MIN_HOLD_SEC=180;NORMAL_EXIT_MIN_HOLD_SEC=160;PROFIT_EXIT_MIN_HOLD_SEC=120
    FAST_ADVERSE_PCT=-4.0;FAST_ADVERSE_MIN_HOLD_SEC=120;ADVERSE_EXIT_PCT=-2.0;ADVERSE_EXIT_MIN_HOLD_SEC=120
    LOT_SIZE=65;ROUND_TRIP_FEE=60.0;MIN_NET_PROFIT_EXIT=100.0;MIN_GROSS_POINTS_FOR_PROFIT_EXIT=2.50
    TIME_LOSS_EXIT_SEC=180;TIME_LOSS_EXIT_PCT=-1.0;DEAD_TRADE_EXIT_SEC=240;DEAD_TRADE_MIN_PROFIT_PCT=0.20
